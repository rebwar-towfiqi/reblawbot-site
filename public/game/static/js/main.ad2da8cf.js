/*! For license information please see main.ad2da8cf.js.LICENSE.txt */
(() => {
  'use strict';
  var e = {
      43: (e, t, n) => {
  ...
  const ze = () => {
    ...
    Re = () => {
      ...
      const n = ee(),
        ...
        i =
          ...
          '\u0646\u0627\u0645\u0634\u062e\u0635',
        u = (null === (t = r.state) || void 0 === t ? void 0 : t.caseId) || 1;
      return (
        l.useEffect(() => {
          ((e, t, n) => {
            const r = [
              ...JSON.parse(localStorage.getItem('caseResults') || '[]'),
              {
                role: e,
                caseId: t,
                verdict: n,
            ...
            localStorage.setItem('caseResults', JSON.stringify(r));
          })(i, u, a);
        }, []),
        (0, Ee.jsxs)('div', {
          className:
    ...
    je = () => (0, Ee.jsx)(ke, { children: (0, Ee.jsx)(Oe, {}) });
  o.createRoot(document.getElementById('root')).render(
    (0, Ee.jsx)(l.StrictMode, { children: (0, Ee.jsx)(je, {}) }),
  );
})();
//# sourceMappingURL=main.ad2da8cf.js.map
