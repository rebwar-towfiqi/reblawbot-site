/*! For license information please see main.91223064.js.LICENSE.txt */
(() => {
  'use strict';
  var t = {
      43: (t, e, n) => {
      ...
      children: [
        (0, bo.jsxs)('div', {
          ...
          children: [
            ...
            (0, bo.jsx)('a', {
              href: 'https://t.me/RebLawCoin_bot?start='.concat(f),
              className:
                'bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded text-sm font-bold',
              target: '_blank',
...
//# sourceMappingURL=main.91223064.js.map
